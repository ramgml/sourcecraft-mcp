...
def register_tools(mcp):
    ...
    async def _list_organizations(
        ...
        return await list_organizations(page=page, per_page=per_page, ctx=ctx)
    ...
    async def _get_organization(
        ...
        return await get_organization(org=org, ctx=ctx)
    ...
    async def _list_organization_repositories(
        ...
        return await list_organization_repositories(org=org, page=page, per_page=per_page, ctx=ctx)
    ...
    async def _list_organization_members(
        ...
        return await list_organization_members(org=org, page=page, per_page=per_page, ctx=ctx)

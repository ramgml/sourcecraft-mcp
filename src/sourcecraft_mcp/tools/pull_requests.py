...
def register_tools(mcp):
    ...
    @mcp.tool()
    async def _discard_pull_request(
        owner: str,
        repo: str,
        pull_number: int,
        ctx: Context | None = None,
    ) -> str:
        return await discard_pull_request(
            owner=owner,
            repo=repo,
            pull_number=pull_number,
            ctx=ctx,
    ...
    @mcp.tool()
    async def _list_pr_reviewers(
        owner: str,
        repo: str,
        pull_number: int,
        ctx: Context | None = None,
    ) -> str:
        return await list_pr_reviewers(
            owner=owner,
            repo=repo,
            pull_number=pull_number,
            ctx=ctx,
    ...
    @mcp.tool()
    async def _set_review_decision(
        owner: str,
        repo: str,
        pull_number: int,
        decision: str,
        ...
        return await set_review_decision(
            owner=owner,
            repo=repo,
            pull_number=pull_number,
            decision=decision,
